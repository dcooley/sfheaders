...
test_that("errors and crashes are handled and fixed",{
  ...
  df <- data.frame(x = 1:5)
  expect_error( sfheaders::sf_linestring(obj = df, x = "x", y = "y") )
  expect_error( sfheaders::sf_linestring(obj = df, x = "x", y = 2 ) )
  ...
  expect_error( sfheaders:::rcpp_sfc_polygon(df, c(0L,1L), 2L, NULL ), "sfheaders - id column index doesn't exist")
  expect_error( sfheaders:::rcpp_sfc_polygon(df, c(0L,1L), NULL, 2L ), "sfheaders - id column index doesn't exist")
  expect_error( sfheaders:::rcpp_sfc_polygon(df, c(0L,1L), 2L, 2L ), "sfheaders - id column index doesn't exist")

  expect_error( sfheaders:::rcpp_sfc_multipolygon(df, c(0L,1L), 2L, NULL, NULL ), "sfheaders - id column index doesn't exist")
  expect_error( sfheaders:::rcpp_sfc_multipolygon(df, c(0L,1L), NULL, 2L, NULL ), "sfheaders - id column index doesn't exist")
  expect_error( sfheaders:::rcpp_sfc_multipolygon(df, c(0L,1L), NULL, NULL, 2L ), "sfheaders - id column index doesn't exist")

  expect_error( sfheaders:::rcpp_sfc_multipolygon(df, c(0L,1L), 2L, 2L, NULL ), "sfheaders - id column index doesn't exist")
  expect_error( sfheaders:::rcpp_sfc_multipolygon(df, c(0L,1L), NULL, 2L, 2L ), "sfheaders - id column index doesn't exist")
  expect_error( sfheaders:::rcpp_sfc_multipolygon(df, c(0L,1L), 2L, NULL, 2L ), "sfheaders - id column index doesn't exist")

  expect_error( sfheaders:::rcpp_sfc_multipolygon(df, c(0L,1L), 2L, 2L, 2L ), "sfheaders - id column index doesn't exist")
  ...
  expect_error( sfheaders:::rcpp_sfc_polygon(m, c(0L,1L), 2L, NULL ), "sfheaders - id column index doesn't exist")
  expect_error( sfheaders:::rcpp_sfc_polygon(m, c(0L,1L), NULL, 2L ), "sfheaders - id column index doesn't exist")
  expect_error( sfheaders:::rcpp_sfc_polygon(m, c(0L,1L), 2L, 2L ), "sfheaders - id column index doesn't exist")

  expect_error( sfheaders:::rcpp_sfc_multipolygon(m, c(0L,1L), 2L, NULL, NULL ), "sfheaders - id column index doesn't exist")
  expect_error( sfheaders:::rcpp_sfc_multipolygon(m, c(0L,1L), NULL, 2L, NULL ), "sfheaders - id column index doesn't exist")
  expect_error( sfheaders:::rcpp_sfc_multipolygon(m, c(0L,1L), NULL, NULL, 2L ), "sfheaders - id column index doesn't exist")

  expect_error( sfheaders:::rcpp_sfc_multipolygon(m, c(0L,1L), 2L, 2L, NULL ), "sfheaders - id column index doesn't exist")
  expect_error( sfheaders:::rcpp_sfc_multipolygon(m, c(0L,1L), NULL, 2L, 2L ), "sfheaders - id column index doesn't exist")
  expect_error( sfheaders:::rcpp_sfc_multipolygon(m, c(0L,1L), 2L, NULL, 2L ), "sfheaders - id column index doesn't exist")

  expect_error( sfheaders:::rcpp_sfc_multipolygon(m, c(0L,1L), 2L, 2L, 2L ), "sfheaders - id column index doesn't exist")


  df <- data.frame(x = 1, y = 2 )
  expect_error( sfheaders:::rcpp_sfg_multilinestring(m, c(0L,1L), 2L ), "sfheaders - id column index doesn't exist")

  expect_error( sfheaders:::rcpp_sfg_polygon(m, c(0L,1L), 2L ), "sfheaders - id column index doesn't exist")

  expect_error( sfheaders:::rcpp_sfg_multipolygon(m, c(0L,1L), 2L, NULL ), "sfheaders - id column index doesn't exist")
  expect_error( sfheaders:::rcpp_sfg_multipolygon(m, c(0L,1L), NULL, 2L ), "sfheaders - id column index doesn't exist")
  expect_error( sfheaders:::rcpp_sfg_multipolygon(m, c(0L,1L), 2L, 2L ), "sfheaders - id column index doesn't exist")
