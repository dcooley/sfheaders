...
test_that("errors and crashes are handled and fixed",{
  ...
  expect_error( sfheaders:::rcpp_sfc_multipoint(df, c(0L,1L), 2L, FALSE), "sfheaders - id column index doesn't exist")
  expect_error( sfheaders:::rcpp_sfc_linestring(df, c(0L,1L), 2L, FALSE), "sfheaders - id column index doesn't exist")
  expect_error( sfheaders:::rcpp_sfc_multilinestring(df, c(0L,1L), 2L, NULL, FALSE ), "sfheaders - id column index doesn't exist")
  expect_error( sfheaders:::rcpp_sfc_multilinestring(df, c(0L,1L), NULL, 2L, FALSE ), "sfheaders - id column index doesn't exist")
  expect_error( sfheaders:::rcpp_sfc_multilinestring(df, c(0L,1L), 2L, 2L, FALSE ), "sfheaders - id column index doesn't exist")
  ...
  m <- matrix( 1:2, ncol = 2)
  expect_error( sfheaders:::rcpp_sfc_multipoint(m, c(0L,1L), 2L, FALSE), "sfheaders - id column index doesn't exist")
  expect_error( sfheaders:::rcpp_sfc_linestring(m, c(0L,1L), 2L, FALSE), "sfheaders - id column index doesn't exist")
  expect_error( sfheaders:::rcpp_sfc_multilinestring(m, c(0L,1L), 2L, NULL, FALSE ), "sfheaders - id column index doesn't exist")
  expect_error( sfheaders:::rcpp_sfc_multilinestring(m, c(0L,1L), NULL, 2L, FALSE ), "sfheaders - id column index doesn't exist")
  expect_error( sfheaders:::rcpp_sfc_multilinestring(m, c(0L,1L), 2L, 2L, FALSE ), "sfheaders - id column index doesn't exist")
  ...
  df <- data.frame(x = 1, y = 2 )
  expect_error( sfheaders:::rcpp_sfg_multilinestring(m, c(0L,1L), 2L, FALSE ), "sfheaders - id column index doesn't exist")
...
test_that("other misc errors are caught",{
  ...
  expect_error( sfheaders:::rcpp_sfg_linestring( x, c(1L, 2L), FALSE ), "sfheaders - invalid column index")
