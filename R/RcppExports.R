...
rcpp_sfc_remove_holes <- function(sfc, xyzm, close) {
    .Call(`_sfheaders_rcpp_sfc_remove_holes`, sfc, xyzm, close)
}
...
rcpp_sfg_remove_holes <- function(sfg, xyzm, close) {
    .Call(`_sfheaders_rcpp_sfg_remove_holes`, sfg, xyzm, close)
}
