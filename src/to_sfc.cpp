...
SEXP rcpp_sfc_points( Rcpp::List lst, bool m_only ) {
  return sfheaders::sfc::sfc_points( lst, m_only );
}

// [[Rcpp::export]]
SEXP rcpp_sfc_multipoint( SEXP x, SEXP cols, SEXP id_col, bool m_only ) {
  return sfheaders::sfc::sfc_multipoint( x, cols, id_col, m_only );
  //return sfheaders::sfc::sfc_multipoints( x );
}

// [[Rcpp::export]]
SEXP rcpp_sfc_multipoints( Rcpp::List lst, bool m_only ) {
  return sfheaders::sfc::sfc_multipoints( lst, m_only );
}

// [[Rcpp::export]]
SEXP rcpp_sfc_linestring( SEXP x, SEXP cols, SEXP id_col, bool m_only ) {
  return sfheaders::sfc::sfc_linestring( x, cols, id_col, m_only );
}

// [[Rcpp::export]]
SEXP rcpp_sfc_linestrings( Rcpp::List lst, bool m_only ) {
  return sfheaders::sfc::sfc_linestrings( lst, m_only );
}

// [[Rcpp::export]]
SEXP rcpp_sfc_multilinestring( SEXP x, SEXP cols, SEXP multiline_id, SEXP line_id, bool m_only ) {
  return sfheaders::sfc::sfc_multilinestring( x, cols, multiline_id, line_id, m_only );
}

// [[Rcpp::export]]
SEXP rcpp_sfc_multilinestrings( Rcpp::List lst, bool m_only ) {
  return sfheaders::sfc::sfc_multilinestrings( lst, m_only );
}

// [[Rcpp::export]]
SEXP rcpp_sfc_polygon( SEXP x, SEXP cols, SEXP polygon_id, SEXP line_id, bool m_only, bool close = true ) {
  return sfheaders::sfc::sfc_polygon( x, cols, polygon_id, line_id, m_only, close );
}

// [[Rcpp::export]]
SEXP rcpp_sfc_polygons( Rcpp::List lst, bool m_only, bool close = true ) {
  return sfheaders::sfc::sfc_polygons( lst, m_only, close );
}


// [[Rcpp::export]]
SEXP rcpp_sfc_multipolygon( SEXP x, SEXP cols, SEXP multipolygon_id, SEXP polygon_id, SEXP linestring_id, bool m_only, bool close = true ) {
  return sfheaders::sfc::sfc_multipolygon( x, cols, multipolygon_id, polygon_id, linestring_id, m_only, close );
}

// [[Rcpp::export]]
SEXP rcpp_sfc_multipolygons( Rcpp::List lst, bool m_only, bool close = true ) {
  return sfheaders::sfc::sfc_multipolygons( lst, m_only, close );
}
