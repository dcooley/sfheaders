...
// rcpp_get_polygons
SEXP rcpp_get_polygons(Rcpp::DataFrame x, Rcpp::StringVector geometry_cols, Rcpp::String polygon_id_column, Rcpp::String line_id_column);
RcppExport SEXP _sfheaders_rcpp_get_polygons(SEXP xSEXP, SEXP geometry_colsSEXP, SEXP polygon_id_columnSEXP, SEXP line_id_columnSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(rcpp_get_polygons(x, geometry_cols, polygon_id_column, line_id_column));
    return rcpp_result_gen;
END_RCPP
}
// rcpp_get_polygons2
SEXP rcpp_get_polygons2(Rcpp::DataFrame x, Rcpp::IntegerVector geometry_cols, int polygon_id_column, int line_id_column);
RcppExport SEXP _sfheaders_rcpp_get_polygons2(SEXP xSEXP, SEXP geometry_colsSEXP, SEXP polygon_id_columnSEXP, SEXP line_id_columnSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::DataFrame >::type x(xSEXP);
    Rcpp::traits::input_parameter< Rcpp::IntegerVector >::type geometry_cols(geometry_colsSEXP);
    Rcpp::traits::input_parameter< int >::type polygon_id_column(polygon_id_columnSEXP);
    Rcpp::traits::input_parameter< int >::type line_id_column(line_id_columnSEXP);
    rcpp_result_gen = Rcpp::wrap(rcpp_get_polygons2(x, geometry_cols, polygon_id_column, line_id_column));
    return rcpp_result_gen;
END_RCPP
}
// rcpp_to_sfg
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_sfheaders_rcpp_get_polygons", (DL_FUNC) &_sfheaders_rcpp_get_polygons, 4},
    {"_sfheaders_rcpp_get_polygons2", (DL_FUNC) &_sfheaders_rcpp_get_polygons2, 4},
