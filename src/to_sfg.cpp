...
// [[Rcpp::export]]
SEXP rcpp_sfg_polygon( SEXP x, SEXP geometry_columns, SEXP line_id, bool m_only, bool close = true ) {
  return sfheaders::sfg::sfg_polygon( x, geometry_columns, line_id, m_only, close );
}

// [[Rcpp::export]]
Rcpp::List rcpp_sfg_polygons( Rcpp::List& lst, bool m_only, bool close = true ) {
  return sfheaders::sfg::sfg_polygons( lst, m_only, close );
}

// [[Rcpp::export]]
SEXP rcpp_sfg_multipolygon( SEXP x, SEXP geometry_columns, SEXP polygon_id, SEXP line_id, bool m_only, bool close = true ) {
  return sfheaders::sfg::sfg_multipolygon( x, geometry_columns, polygon_id, line_id, m_only, close );
}

// [[Rcpp::export]]
Rcpp::List rcpp_sfg_multipolygons( Rcpp::List& lst, bool m_only, bool close = true ) {
  return sfheaders::sfg::sfg_multipolygons( lst, m_only, close );
}
