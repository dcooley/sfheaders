...
Having said that, here are some example `cppFunction()` calls you can use to make various sf objects
...
Then you can include the `sfheaders` header files (now you understand the name!) an a .cpp file and away you go
