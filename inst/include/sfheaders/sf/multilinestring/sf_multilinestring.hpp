...
//   return sf_multilinestring( df, str_geometry_cols, multiline_ids, line_ids, property_cols );
// }
//
// inline SEXP sf_multilinestring(
//     Rcpp::DataFrame& df,
...
//   return sf_multilinestring( df, geometry_cols, multiline_ids, line_ids, property_cols );
// }
//
// inline SEXP sf_multilinestring(
//     Rcpp::DataFrame& df,
...
//
//   SEXP line_ids = df[ multilinestring_id ];
//   return sf_multilinestring( df, geometry_cols, line_ids, property_cols );
// }
//
// inline SEXP sf_multilinestring(
//     Rcpp::NumericMatrix& nm,
