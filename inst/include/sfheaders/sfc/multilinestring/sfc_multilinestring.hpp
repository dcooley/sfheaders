...
namespace sfc {
  ...
  inline SEXP sfc_multilinestring(
    ...
    Rcpp::List mp = sfheaders::sfg::sfg_multilinestring( im, m_only );
  ...
  inline SEXP sfc_multilinestring(
    ...
    Rcpp::List mp = sfheaders::sfg::sfg_multilinestring( nm, m_only );
  ...
  inline SEXP sfc_multilinestring(
    ...
    Rcpp::List mp = sfheaders::sfg::sfg_multilinestring( df, m_only );
  ...
  inline SEXP sfc_multilinestring(
    ...
    im(0, Rcpp::_ ) = iv;
    return sfc_multilinestring( im, m_only );
  }
  ...
  inline SEXP sfc_multilinestring(
    ...
    nm(0, Rcpp::_ ) = nv;
    return sfc_multilinestring( nm, m_only );
  }
...
// }
  ...
  inline SEXP sfc_multilinestring(
    ...
    case INTSXP: {
      ...
      return sfc_multilinestring( iv, m_only );
    }
    }
    case REALSXP: {
      if( Rf_isMatrix( x ) ) {
      ...
      return sfc_multilinestring( nv, m_only );
    }
    }
    case VECSXP: {
      if( Rf_inherits( x, "data.frame" ) ) {
      Rcpp::DataFrame df = Rcpp::as< Rcpp::DataFrame >( x );
      return sfc_multilinestring( df, m_only );
    }
    }
    default: {
  ...
  inline SEXP sfc_multilinestring(
    ...
    Rcpp::List sfc( 1 );
    Rcpp::List sfg = sfheaders::sfg::sfg_multilinestring( im, geometry_cols, m_only );
    sfc[0] = sfg;
    sfheaders::sfc::make_sfc( sfc, sfheaders::sfc::SFC_MULTILINESTRING, bbox, z_range, m_range );
    return sfc;
  }
  ...
  inline SEXP sfc_multilinestring(
    ...
    Rcpp::List sfc( 1 );
    Rcpp::List sfg = sfheaders::sfg::sfg_multilinestring( df, geometry_cols, m_only );
    sfc[0] = sfg;
    sfheaders::sfc::make_sfc( sfc, sfheaders::sfc::SFC_MULTILINESTRING, bbox, z_range, m_range );
    return sfc;
  }
  ...
  inline SEXP sfc_multilinestring(
    ...
    Rcpp::List sfc( 1 );
    Rcpp::List sfg = sfheaders::sfg::sfg_multilinestring( nm, geometry_cols, m_only );
    sfc[0] = sfg;
    sfheaders::sfc::make_sfc( sfc, sfheaders::sfc::SFC_MULTILINESTRING, bbox, z_range, m_range );
    return sfc;
  }
  ...
  inline SEXP sfc_multilinestring(
    ...
    case INTSXP: {
      if( Rf_isMatrix( x ) ) {
      Rcpp::IntegerMatrix im = Rcpp::as< Rcpp::IntegerMatrix >( x );
      return sfc_multilinestring( im, geometry_cols, m_only );
      // } else {
      //   Rcpp::IntegerVector iv = Rcpp::as< Rcpp::IntegerVector >( x );
    ...
    case REALSXP: {
      if( Rf_isMatrix( x ) ) {
      Rcpp::NumericMatrix nm = Rcpp::as< Rcpp::NumericMatrix >( x );
      return sfc_multilinestring( nm, geometry_cols, m_only );
      // } else {
      //   Rcpp::NumericVector nv = Rcpp::as< Rcpp::NumericVector >( x );
    ...
    case VECSXP: {
      if( Rf_inherits( x, "data.frame" ) ) {
      Rcpp::DataFrame df = Rcpp::as< Rcpp::DataFrame >( x );
      return sfc_multilinestring( df, geometry_cols, m_only );
    }
    }
    default: {
      Rcpp::stop("sfheaders - unsupported multilinestring type");
  ...
  inline SEXP sfc_multilinestring(
    ...
    case INTSXP: {
      ...
      return sfc_multilinestring( x, iv, m_only );
    }
    case STRSXP: {
      Rcpp::StringVector sv = Rcpp::as< Rcpp::StringVector >( geometry_cols );
      return sfc_multilinestring( x, sv, m_only );
    }
    default: {
...
// }
  ...
  inline SEXP sfc_multilinestring(
    ...
    for( i = 0; i < n_multilinestrings; ++i ) {
      ...
      sfc( i ) = sfheaders::sfg::sfg_multilinestring( df_subset, geometry_cols, linestring_id, m_only );
    }
  ...
  inline SEXP sfc_multilinestring(
    ...
    return sfc_multilinestring( df, str_geometry_cols, str_linestring_id, multilinestring_positions, m_only );
  }
  ...
  inline SEXP sfc_multilinestring(
    ...
    return sfc_multilinestring( df, geometry_cols, linestring_id, multilinestring_positions, m_only );
  }
  ...
  inline SEXP sfc_multilinestring(
    ...
    for( i = 0; i < n_multilinestrings; ++i ) {
      ...
      sfc( i ) = sfheaders::sfg::sfg_multilinestring( im2, geometry_cols, linestring_id, m_only );
    }
  ...
  inline SEXP sfc_multilinestring(
    ...
    Rcpp::IntegerMatrix multilinestring_positions = sfheaders::utils::id_positions( multilinestring_ids );
    return sfc_multilinestring( im, geometry_cols, linestring_id, multilinestring_positions, m_only );
  }
  ...
  inline SEXP sfc_multilinestring(
    ...
    for( i = 0; i < n_multilinestrings; ++i ) {
      ...
      sfc( i ) = sfheaders::sfg::sfg_multilinestring( nm2, geometry_cols, linestring_id, m_only );
    }
  ...
  inline SEXP sfc_multilinestring(
    ...
    Rcpp::IntegerMatrix multilinestring_positions = sfheaders::utils::id_positions( multilinestring_ids );
    return sfc_multilinestring( nm, geometry_cols, linestring_id, multilinestring_positions, m_only );
  }
  ...
  inline SEXP sfc_multilinestring(
    ...
    return sfc_multilinestring( im, geometry_cols, multilinestring_ids, linestring_id, m_only );
  }
  ...
  inline SEXP sfc_multilinestring(
    ...
    return sfc_multilinestring( nm, geometry_cols, multilinestring_ids, linestring_id, m_only );
  }
  ...
  inline SEXP sfc_multilinestring(
    ...
    return sfc_multilinestring( df, geometry_cols, multilinestring_ids, linestring_id, m_only );
  }
  ...
  inline SEXP sfc_multilinestring(
    ...
    Rcpp::DataFrame df = Rcpp::as< Rcpp::DataFrame >( im );
    return sfc_multilinestring( df, geometry_cols, multilinestring_id, linestring_id, m_only );
  }
  ...
  inline SEXP sfc_multilinestring(
    ...
    case INTSXP: {
      if( Rf_isMatrix( x ) ) {
      Rcpp::IntegerMatrix im = Rcpp::as< Rcpp::IntegerMatrix >( x );
      return sfc_multilinestring( im, geometry_cols, multilinestring_id, linestring_id, m_only );
      // } else {
      // Rcpp::IntegerVector iv = Rcpp::as< Rcpp::IntegerVector >( x );
    ...
    case REALSXP: {
      if( Rf_isMatrix( x ) ) {
      Rcpp::NumericMatrix nm = Rcpp::as< Rcpp::NumericMatrix >( x );
      return sfc_multilinestring( nm, geometry_cols, multilinestring_id, linestring_id, m_only );
      // } else {
      //   Rcpp::NumericVector nv = Rcpp::as< Rcpp::NumericVector >( x );
  ...
  inline SEXP sfc_multilinestring(
    ...
    if( Rf_isNull( geometry_cols ) ) {
      ...
      return sfc_multilinestring( x, geometry_cols2, multilinestring_id, linestring_id, m_only );
    }
    ...
    if( Rf_isNull( linestring_id ) &&
      ...
      return sfc_multilinestring( x, geometry_cols, m_only );
    }
    //
    ...
    if ( Rf_isNull( multilinestring_id ) &&
      ...
      sfc[0] = sfheaders::sfg::sfg_multilinestring( x, geometry_cols, linestring_id, m_only );
      sfheaders::sfc::make_sfc( sfc, sfheaders::sfc::SFC_MULTILINESTRING, bbox, z_range, m_range );
      return sfc;
    }
    ...
    if ( !Rf_isNull( multilinestring_id ) &&
      ...
      return sfc_multilinestring( x, geometry_cols, multilinestring_id, linestring_id2, m_only );
    }
    ...
    if( !Rf_isNull( multilinestring_id ) &&
      ...
      case INTSXP: {
        ...
        return sfc_multilinestring( x, iv_geometry_cols, i_multilinestring_id_col, i_linestring_id_col, m_only );
      ...
      case STRSXP: {
        ...
        return sfc_multilinestring( x, sv_geometry_cols, s_multilinestring_id_col, s_linestring_id_col, m_only );
      }
      default: {
        Rcpp::stop("sfheaders - unsupported multilinestring type");  // #nocov
      }
